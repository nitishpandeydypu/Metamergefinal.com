...
From lead generation to closing sales, supporting customers to marketing automation — everything is now in your control. Boost your business with our All-In-One CRM software designed for Indian entrepreneurs.            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {plans.map((plan) => (
              <div
                key={plan.name}
                className={`relative bg-[#111827] border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/30 ${planColorMap[plan.color]}`}
              >
                {plan.popular && (
      ...
      {/* CTA Banner */}
      <section className="py-10 px-6 bg-gradient-to-r from-[#128c7e] via-[#25d366] to-[#075e54]">
