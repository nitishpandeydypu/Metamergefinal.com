...
export default function BecomeAPartner() {
  return (
    <div>
      {/* Hero */}
      <section className="hero-bg grid-bg relative overflow-hidden py-10 px-6">
      ...
      {/* Shape Your Future */}
      <section className="py-10 px-6 bg-[#0a0f1e]">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col gap-6">
            <div className="bg-gradient-to-br from-green-500/10 to-blue-500/5 border border-green-500/20 rounded-2xl p-10 text-center">
              <div className="w-20 h-20 bg-green-500/20 border border-green-500/30 rounded-2xl flex items-center justify-center text-4xl mx-auto mb-6">
                🚀
              </div>
      ...
      {/* Contact Form */}
      {/* <section id="contact-form" className="py-10 px-6 bg-[#0d1326]">
      ...
      {/* CTA Banner */}
      <section className="py-10 px-6 bg-gradient-to-r from-[#00d4ff] via-[#2563eb] via-[#7e22ce] to-[#ff00aa]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              href="https://wa.me/917827944832"
              className="bg-white text-purple-700 font-bold px-10 py-3 rounded-full text-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              💬 Talk to Sales
            </a>
            <Link
