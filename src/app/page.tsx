...
export default function HomePage() {
  ...
  const [openSupport, setOpenSupport] = useState(false); // ✅ YE LINE ADD KAR
  ...
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-14 items-center">
    ...
    <div>
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <a
          href="https://t.me/metamerge_download/2"
          target="_blank"
    ...
    <div className="relative flex justify-center lg:justify-end animate-fade-in">
      <div className="relative w-full max-w-lg">
        ...
        {/* Bottom Card */}
        <div className="absolute -bottom-6 -right-6 z-10 glass-card rounded-2xl p-4 shadow-xl border border-white/10 animate-float">
          <p className="text-slate-400 text-xs mb-1">Client Revenue Generated</p>
          <p className="text-brand-green font-bold text-2xl font-heading">₹10L+</p>
          <p className="text-green-400 text-xs">↑ Growing daily</p>
        </div>
