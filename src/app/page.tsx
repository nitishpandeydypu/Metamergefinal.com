  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-slate-400 mb-6">
              WhatsApp marketing, CRM, and automation tools to scale your business fast.
            </p>
      ...
      <a
        ...
        className="fixed left-4 bottom-6 z-50 flex items-center gap-2 bg-green-500 text-white px-5 py-3 rounded-full shadow-[0_0_20px_rgba(34,197,94,0.6)] hover:shadow-[0_0_30px_rgba(34,197,94,0.9)] transition-all duration-300 hover:scale-110"
      >
        🎧 Support
      </a>
