...
export default function ClientLayout({
  ...
  useEffect(() => {
    ...
    window.localStorage.setItem("metamerge-theme", "light");
  }, []);

  useEffect(() => {
    document.documentElement.setAttribute("data-theme", theme);
    window.localStorage.setItem("metamerge-theme", theme);
  }, [theme]);
  ...
  return (
    <>
      <Navbar theme={theme} toggleTheme={toggleTheme} setOpenSupport={setOpenSupport} />
...
${(form.elements.namedItem("message") as HTMLTextAreaElement).value}`;
            ...
            >
              ...
              <textarea
                name="message"
                placeholder="Message"
                className="border p-3 rounded h-32 w-full"
              />
